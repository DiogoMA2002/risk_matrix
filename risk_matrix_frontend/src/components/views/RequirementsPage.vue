        ...
        <div class="space-y-6 text-gray-700">
          ...
          <div class="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
            <div class="flex items-start">
              ...
              <div class="ml-3">
                <p class="text-sm text-gray-600">
                  <strong>Importante:</strong> Por questões de segurança e privacidade, após a submissão das respostas e geração do relatório, todos os dados inseridos serão automaticamente eliminados do sistema. Certifique-se de guardar uma cópia do relatório gerado, pois não será possível recuperar as respostas posteriormente.
                </p>
              </div>
            </div>
          </div>
