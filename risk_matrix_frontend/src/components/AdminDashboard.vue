<template>
  <!-- Force the container to full screen height and allow vertical scrolling -->
    ...
    <div class="container mx-auto px-4 py-6">
      ...
      <div class="flex items-center mb-6">
        ...
        <div class="text-white">
          ...
          <p class="text-sm opacity-80">Gerencie questões e categorias</p>
        </div>
      </div>
  ...
  methods: {
    ...
    async addQuestion() {
      if (!this.newQuestion || !this.selectedCategory) {
        alert("Por favor, insira uma questão e selecione uma categoria.");
        return;
      }
      ...
      try {
        ...
        this.fetchQuestions(); // Atualiza a lista de questões
      } catch (error) {
...
<style>
/* Ensure html/body have 100% height for the .h-screen container to work */
html, body {
  height: 100%;
  margin: 0;
  padding: 0;
