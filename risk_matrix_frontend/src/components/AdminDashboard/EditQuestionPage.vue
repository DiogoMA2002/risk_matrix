      ...
      <div
        ...
        <form v-else @submit.prevent="saveQuestion" class="space-y-6 text-gray-700">
          ...
          <div>
            ...
            <input id="questionText" v-model="question.questionText" type="text" required
          ...
          <div>
            ...
            <select v-else id="category" v-model="question.categoryName" required
              ...
              <option v-if="!loadingCategories && !categoryError && !availableCategories.length" disabled value="">No
            ...
            <div class="space-y-4">
              <div v-for="(option, index) in question.options" :key="index" class="p-4 bg-indigo-50 rounded-lg">
                <div class="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-2 md:space-y-0">
                  <!-- Option Text -->
                  <div class="flex-1">
                    <label :for="'optionText-' + index" class="block text-sm font-medium text-gray-700">Option
                      Text</label>
                    <input :id="'optionText-' + index" type="text" v-model="option.optionText" placeholder="Option text"
                      required
                  ...
                  <div class="flex-1">
                    ...
                    <select :id="'optionLevel-' + index" v-model="option.optionLevel" required
                      class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all duration-300">
          ...
          <div class="mt-8 pt-4 border-t border-gray-200">
            <div class="flex justify-between items-center">
              ...
              <button type="submit" :disabled="isSaving || loading"
                ...
                <svg v-if="isSaving" class="animate-spin h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                  viewBox="0 0 24 24">
                ...
                <svg v-if="!isSaving" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none"
