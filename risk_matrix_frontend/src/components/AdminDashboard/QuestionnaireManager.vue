      ...
      >
        <div class="p-4 flex items-start">
          ...
          <div class="ml-3 flex-1 pt-0.5">
            <p class="text-sm font-medium" :class="toast.type === 'success' ? 'text-green-800' : 'text-red-800'">{{ toast.message }}</p>
          </div>
          <button @click="toast.show = false" class="ml-4 flex-shrink-0 text-gray-400 hover:text-gray-500">
  ...
  methods: {
    ...
    showToast(msg, type = 'success') {
      ...
      this.toast = {
        ...
        message: msg,
        type,
        timeout: setTimeout(() => { this.toast.show = false; }, 3000)
      };
    }
  }
};
